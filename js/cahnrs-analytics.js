...
( function( document, window ) {
	...
	window.ca_track_link = function( c_link ){
		...
		if ( typeof href !== typeof undefined && href !== false ) { // not an anchor
	...
	window.ca_get_link_name = function( c_link ){
		...
		if ( typeof title !== typeof undefined && title !== false ) { // not an anchor
...
* 
* Source: https://github.com/lunametrics/youtube-google-analytics
*
* Version: 7
*/

/**
* DB Added: Moded event tracking function to not use window datalayer.
*/
